...
//
//		Vector3 relaticeVelocity = physA->GetLinearVelocity() - physB->GetLinearVelocity();
//
...
//			float velocityDot = Vector3::Dot(relaticeVelocity, offsetDir);
...
//
//			physA->ApplyLinearImpulse(aImpulse);//multiplies by mass here
//			physB->ApplyLinearImpulse(bImpulse);//multiplies by mass here
//		}
//	}
//}
